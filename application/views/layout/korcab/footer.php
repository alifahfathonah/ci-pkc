    ...
    <script type="text/javascript" src="<?php echo base_url('asset/vendor/metisMenu/metisMenu.min.js') ?>"></script>

    <!-- Custom Theme JavaScript -->
    <script type="text/javascript" src="<?php echo base_url('asset/dist/js/sb-admin-2.js') ?>"></script>