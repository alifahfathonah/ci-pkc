     		...
     		<form class="form-horizontal" method="POST" enctype="multipart/form-data">
     			...
     			<div class="modal-body">
     				<input type="hidden" name="txt_id" id="txt_id">
                         ...
                         <div class="form-group">
                              <label for="txt_pesan" class="col-md-3 control-label">Pesan</label>
                              <div class="col-md-9">
                                  <textarea name="txt_pesan" id="txt_pesan" cols="10" rows="5" class="form-control" readonly></textarea>
                              </div>
                         </div>
                         <div class="form-group">
                              <label for="txt_balas" class="col-md-3 control-label">Balas Pesan</label>
                              <div class="col-md-9">
                                  <textarea name="txt_balas" id="txt_balas" cols="10" rows="5" class="form-control readonly"></textarea>
                              </div>
                         </div>
     			</div>
